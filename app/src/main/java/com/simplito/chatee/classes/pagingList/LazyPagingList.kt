...
fun <Value : Any> LazyPagingColumn(
    ...
    errorComponent: @Composable BoxScope.(error: Throwable) -> Unit = { ErrorComponent(errorMessage(it), Modifier.align(Alignment.Center)) },
    emptyListComponent: @Composable BoxScope.(message: String) -> Unit = { EmptyListComponent(emptyListMessage(), Modifier.align(Alignment.Center)) },
